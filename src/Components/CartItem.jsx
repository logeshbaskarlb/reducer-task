...
const CartItem = ({ product }) => {
  ...
  return (
    <div className="card mt-1 px-md-4 py-md-4">
      <div className="row g-0">
        ...
        <div className="col-md-6">
          <div className="card-body">
            ...
            <div>
              <span className="text-success">Instock :</span> {product.stock}
            </div>
        ...
        <div className="col-md-12 col-lg-3 text-end d-flex flex-column justify-content-between">
          <div className="mx-2">
            <div className="me-lg-2  pe-lg-4 ">
              <span className="me-4">Price:</span>${product.price}
            </div>
            <div className="mt-2">
              ...
              <span className="mx-lg-3">
                ...
                <button
                  className="btn btn-sm btn-outline-dark"
                  onClick={() => dispatch(incQuantity(product))}
                >
                  +
                </button>
              </span>
